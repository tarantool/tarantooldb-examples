...
> **Заметка**
> 
> Стенд с Telegraf и InfluxDB можно посмотреть [здесь](../java_balancer/)
...
Убедитесь, что графики показывают данные за последние 5 минут, а частота обновления равна 5 секундам.
...
Включите отображение графиков стораджей и оцените их:
