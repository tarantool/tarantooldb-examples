...
> приведен в разделе [Балансировщик запросов к роутерам через Java-коннектор](https://www.tarantool.io/docs/tdb/ru/2_x/user_guide/connectors/java/connectors_java_balancer).
...
>  * Отдельный архив [go_balancer.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fgo_balancer&filename=go_balancer), скачанный из этого репозитория.
