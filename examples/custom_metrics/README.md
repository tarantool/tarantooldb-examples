...
>  * Отдельный архив [custom_metrics.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-3x%2Fmaster%2Fexamples%2Fcustom_metrics&filename=custom_metrics), скачанный из этого репозитория.
...
![График метрики Custom count в Grafana](images/custom_count.png)
