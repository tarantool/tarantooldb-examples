...
>  * Отдельный архив [read_view.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fread_view&filename=read_view), скачанный из этого репозитория.
...
- кластера Tarantool DB:
  ...
  - 1 [Tarantool Cluster Manager](https://www.tarantool.io/docs/tdb/ru/2_x/getting_started#getting_started-tcm);
...
> [!NOTE]
> Если вы укажете ключ шардирования (`bucket_id`), операция `select` будет выполнена на одном узле.
