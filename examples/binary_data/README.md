...
* [Запись бинарных данных](#запись-бинарных-данных)
...
>  * Отдельный архив [binary_data.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fbinary_data&filename=binary_data), скачанный из этого репозитория.
