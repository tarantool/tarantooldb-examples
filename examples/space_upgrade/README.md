...
Подробнее о миграции можно прочитать в разделе [Миграция данных](https://www.tarantool.io/docs/tdb/ru/3_x/user_guide/migrations).
...
>  * Отдельный архив [space_upgrade.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-3x%2Fmaster%2Fexamples%2Fspace_upgrade&filename=space_upgrade), скачанный из этого репозитория.
