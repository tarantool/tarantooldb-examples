...
>  * Отдельный архив [up_with_docker_compose.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fup_with_docker_compose&filename=up_with_docker_compose), скачанный из этого репозитория.
...
* `environment` — переменные окружения для опций Tarantool:
  ...
  * `TT_CONFIG_ETCD_HTTP_REQUEST_TIMEOUT` — таймаут запроса для получения конфигурации.
  ...
  Полный список опций доступен в описании [Docker-образа](https://www.tarantool.io/docs/tdb/ru/2_x/install_and_upgrade/install/install_docker#install_docker-image-description) Tarantool DB.
