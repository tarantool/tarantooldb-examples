...
![](./images/replication_lag_sync2.png)
Как можно заметить значение подскачило до 130ms. Синхронная репликация чуть медленнее отрабатывает. Это связано с тем, что ко времени коммита прибавляется replication_lag.
