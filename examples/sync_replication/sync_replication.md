...
Также можно обратить внимание на другие метрики:
![](./images/insert_requests.png)
На графиках можно заметить сначала увеличивающуюся нагрузку, а потом стабилизацию.
По этим графикам можно следить за INSERT запросами к Tarantool. В Клиенстком приложении как раз используется вставка данных.
Также есть и другие графики, например, REPLACE, SELECT. В зависимости от особенностей вашего клиентского приложения, можно будет наблюдать нагрузку на соответствующих графиках.
