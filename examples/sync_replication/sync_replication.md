...
Из этого следует, что допускается выборочное включение синхронной репликации на отдеьные спейсы.
