...
> Если в режиме `manual` увеличить значение параметра `replication_synchro_timeout` до 86900, синхронные транзакции не будут откатываться по истечении времени ожидания.
