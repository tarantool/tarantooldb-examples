...
В этом руководстве показано, как настроить [конфигурацию мастер-мастер](https://www.tarantool.io/ru/doc/latest/platform/replication/repl_architecture/#replication-roles-master-and-replica), а также установить персистентный триггер для
разрешения конфликта репликации.
...
>  * Отдельный архив [triggers.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Ftriggers&filename=triggers), скачанный из этого репозитория.
...
- 1 узел [Tarantool Cluster Manager](https://www.tarantool.io/docs/tdb/ru/2_x/getting_started#getting_started-tcm) (TCM).
