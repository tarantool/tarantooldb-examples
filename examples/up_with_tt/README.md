...
Если нужно скачать утилиту отдельно, обратитесь к разделу [Установка tt CLI](https://www.tarantool.io/docs/tdb/ru/3_x/install_and_upgrade/install_tt).
...
>  * Отдельный архив [up_with_tt.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-3x%2Fmaster%2Fexamples%2Fup_with_tt&filename=up_with_tt), скачанный из этого репозитория.
