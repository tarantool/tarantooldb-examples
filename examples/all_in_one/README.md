...
Начальная загрузка модуля [шардирования](https://www.tarantool.io/ru/doc/latest/platform/sharding/)
выполняется утилитой [tt CLI](https://www.tarantool.io/docs/tdb/ru/2_x/install_and_upgrade/install_tt)
...
>  * Отдельный архив [all_in_one.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fall_in_one&filename=all_in_one), скачанный из этого репозитория.
...
![Вкладка Stateboard в TCM с кластером из одного узла](images/tcm-stateboard-1_node.png)
