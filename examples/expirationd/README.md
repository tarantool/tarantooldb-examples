...
>  * Отдельный архив [expirationd.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-3x%2Fmaster%2Fexamples%2Fexpirationd&filename=expirationd), скачанный из этого репозитория.
...
Смотрите также: [Проверка устаревших кортежей в спейсе с помощью пользовательских функций](https://www.tarantool.io/docs/tdb/ru/3_x/user_guide/expirationd/expirationd_user_logic).
