...
В этом руководстве показано, как запустить два независимых кластера Tarantool DB в Docker в связке с [Tarantool Clusters Federation](https://www.tarantool.io/docs/tcf/ru/0_12/about) (TCF)
...
> Это означает, что передача [словарей](https://www.tarantool.io/docs/tdb/ru/2_x/user_guide/dictionary) через TCF недоступна.
...
>  * Отдельный архив [tarantool_clusters_federation.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Ftarantool_clusters_federation&filename=tarantool_clusters_federation), скачанный из этого репозитория.
...
Подробная информация о доступных [опциях конфигурации TCF](https://www.tarantool.io/docs/tcf/ru/0_12/references/cluster_yaml_3-0) 
...
Откройте вкладку **Tuples** и убедитесь, что репликация на второй кластер прошла успешно — в спейсе `writers` тоже появился новый кортеж.
