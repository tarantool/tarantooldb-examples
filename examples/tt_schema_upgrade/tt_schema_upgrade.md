...
* исходные файлы примера `tt_schema_upgrade`.
  ...
  * Архив с полной документацией Tarantool DB, полученный по почте или скачанный в [личном кабинете tarantool.io](https://www.tarantool.io/en/accounts/customer_zone/packages/tarantooldb/release/documentation).
    ...
    Пример `tt_schema_upgrade` расположен в таком архиве в директории `./doc/examples/tt_schema_upgrade/`.
...
Предупреждение об устарешей схеме БД пропадет после успешного обновления схемы.
