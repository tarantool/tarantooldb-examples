...
>  * Отдельный архив [dictionary.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fdictionary&filename=dictionary), скачанный из этого репозитория.
...
Узнать больше о спейсе `dictionary_data` можно в разделе [Начало работы с модулем dictionary](https://www.tarantool.io/docs/tdb/ru/2_x/user_guide/dictionary/dictionary_gs).
...
Для записи элементов с соответствующими им ключами в словарь используется метод [dictionary_router_set()](https://www.tarantool.io/docs/tdb/ru/2_x/reference/api_reference/dictionary#reference_lua-dictionary-set).
...
Вызвать метод в новом формате через [tt CLI](https://www.tarantool.io/docs/tdb/ru/2_x/install_and_upgrade/install_tt) или в [TCM](https://www.tarantool.io/docs/tdb/ru/2_x/getting_started#getting_started-tcm) во вкладке **Terminal** (`TT Connect`)
...
Во вкладке **Terminal** с помощью метода [dictionary_router_set()](https://www.tarantool.io/docs/tdb/ru/2_x/reference/api_reference/dictionary#reference_lua-dictionary-set) запишите несколько элементов (`Shops`, `Food delivery` и другие) с соответствующими им ключами в словарь:
...
Чтобы проверить записанные в словарь данные, используйте метод [dictionary_router_get()](https://www.tarantool.io/docs/tdb/ru/2_x/reference/api_reference/dictionary#reference_lua-dictionary-get):
