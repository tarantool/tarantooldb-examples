...
```{admonition} Права доступа к кластеру и словарям
:class: note
...
* исходные файлы примера `dictionary`.
  ...
  * Отдельный архив [dictionary.tar.gz](https://tarantool.io/ru/tarantooldb/doc/2.x/examples/dictionary/dictionary.tar.gz), скачанный c сайта Tarantool.
  ```
