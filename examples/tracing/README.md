...
Подробнее о модуле `tracing` можно узнать в разделе [Оценка производительности](https://www.tarantool.io/docs/tdb/ru/3_x/admin_guide/troubleshooting/tracing).
...
>  * Отдельный архив [tracing.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-3x%2Fmaster%2Fexamples%2Ftracing&filename=tracing), скачанный из этого репозитория.
...
Полное описание опций конфигурации `tracing` приведено в соответствующем разделе [Справочника по конфигурации](https://www.tarantool.io/docs/tdb/ru/3_x/reference/configuration_reference#configuration_reference-tracing).
