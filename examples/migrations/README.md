...
>  * Отдельный архив [migrations.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-3x%2Fmaster%2Fexamples%2Fmigrations&filename=migrations), скачанный из этого репозитория.
...
* Спейсы `projects` и `tasks` имеют одинаковый [ключ шардирования](https://www.tarantool.io/docs/tdb/ru/3_x/admin_guide/sharding) `project_id` и находятся на одном экземпляре.
