...
> [!NOTE]
> Пример стенда с [Prometheus](https://prometheus.io/) приведен в разделе [Балансировщик запросов к роутерам через Go-коннектор](https://www.tarantool.io/docs/tdb/ru/2_x/user_guide/connectors/go/connectors_go_balancer).
...
>  * Отдельный архив [java_balancer.zip](https://download-directory.github.io/?url=https%3A%2F%2Fgithub.com%2Ftarantool%2Ftarantooldb-examples%2Ftree%2Frelease-2x%2Fmaster%2Fexamples%2Fjava_balancer&filename=java_balancer), скачанный из этого репозитория.
